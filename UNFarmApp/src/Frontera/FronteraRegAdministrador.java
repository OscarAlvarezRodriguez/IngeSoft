...
public class FronteraRegAdministrador extends javax.swing.JPanel {

    Funciones f = new Funciones();
    RegistrarAdministrador administrador = new RegistrarAdministrador();
    DAO.DrogueriaDAO ddao = new DrogueriaDAO();
    

    public FronteraRegAdministrador() {
        initComponents();
        allSetEmpty();
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if (administrador.validarDatos(e).equals("Registro exitoso")) {
        ...
        } else if (administrador.validarDatos(e).equals("El empleado ya está registrado")) {
            JLabel lb = new JLabel();
            lb.setSize(50, 50);
            JOptionPane.showMessageDialog(null,
                    "La drogueria ya tiene administrador",
                    "Registro Fallido",
    ...
    private void txtNombreFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNombreFocusLost
        if (!txtNombre.getText().equals("")) {
            if (administrador.validarNombre(txtNombre.getText())
    ...
    private void txtApellidoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtApellidoFocusLost
        if (!txtApellido.getText().equals("")) {
            if (administrador.validarApellido(txtApellido.getText())
    ...
    private void txtCedulaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCedulaFocusLost
        if (!txtCedula.getText().equals("")) {
            if (administrador.validarCedula(txtCedula.getText())
    ...
    private void txtContraseniaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtContraseniaFocusLost
        if (!txtContrasenia.getText().equals("")) {
            if (administrador.validarLongitudContrasenia(txtContrasenia.getText())
                    .equals("Longitud contraseña incorrecta")
                    || administrador.validarMayusculaContrasenia(txtContrasenia.getText())
                            .equals("Mayúscula en contraseña incorrecto")
                    || administrador.validarNumeroContrasenia(txtContrasenia.getText())
    ...
    private void txtVerContraseniaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtVerContraseniaFocusLost
        if (!txtVerContrasenia.getText().equals("")) {
            if (!(administrador.compararContrasenia(txtContrasenia.getText(),
    ...
    private void txtDireccionFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtDireccionFocusLost
        if (!txtDireccion.getText().equals("")) {
            if (administrador.validarDireccion(
    ...
    private void txtTelefonoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTelefonoFocusLost
        if (!txtTelefono.getText().equals("")) {
            if (administrador.validarTelefono(
    ...
    private void txtCorreoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtCorreoFocusLost
        if (!txtCorreo.getText().equals("")) {
            if (administrador.validarCorreo(
